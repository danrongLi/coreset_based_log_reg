...
def run_pipeline(selected_ada, X_train,X_train_entire, y_train,y_train_entire, X_test,y_test, gene_names,model_features, resolution=1.0, min_prop=0.0):
    ...
    file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/reports/classification_report_simonson_size_{X_train_size}.csv'
...
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_simonson_entire.pdf", format="pdf")
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_simonson_train.pdf", format="pdf")
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_simonson_test.pdf", format="pdf")
...
for size in coreset_size:
    ...
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    plt.savefig(f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_simonson_train_sampled_{size}.pdf", format="pdf")
