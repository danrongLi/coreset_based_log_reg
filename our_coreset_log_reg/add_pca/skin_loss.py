...
def run_pipeline(selected_ada, X_train,X_train_entire, y_train,y_train_entire, X_test,y_test, gene_names,model_features, resolution=1.0, min_prop=0.0):
    ...
    file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/reports/classification_report_skin_size_{X_train_size}_pca_0.001.csv'
    ...
    cm_file = (
        ...
        f"test_train_split/add_crossval_fix_cellnum/pdf/confusion_matrix_skin_size_{X_train_size}_pca_0.001.pdf"
    )
    plt.savefig(cm_file)
    plt.close()
...
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_skin_entire_pca.pdf", format="pdf")
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_skin_train_pca.pdf", format="pdf")
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_skin_test_pca.pdf", format="pdf")
...
for size in coreset_size:
    ...
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    plt.savefig(f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_skin_train_sampled_{size}_pca.pdf", format="pdf")
