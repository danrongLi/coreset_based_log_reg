...
def run_pipeline(selected_ada, X_train,X_train_entire, y_train,y_train_entire, X_test,y_test, gene_names,model_features, resolution=1.0, min_prop=0.0):
    ...
    file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/reports/classification_report_skin_size_{X_train_size}.csv'
...
selected_ada = selected_ada[~selected_ada.obs['celltype_coarse'].isna()]
...
cell_type_counts = selected_ada.obs['celltype_coarse'].value_counts()
...
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_skin_entire.pdf", format="pdf")
...
for train_indices, test_indices in splitter.split(selected_ada.X, selected_ada.obs['celltype_coarse']):
    adata_train = selected_ada[train_indices].copy()
    adata_test = selected_ada[test_indices].copy()
X_train = adata_train.X
y_train = adata_train.obs["celltype_coarse"]
X_test = adata_test.X
y_test = adata_test.obs["celltype_coarse"]
