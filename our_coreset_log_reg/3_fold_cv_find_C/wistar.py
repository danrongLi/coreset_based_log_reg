...
def run_pipeline(selected_ada, X_train,X_train_entire, y_train,y_train_entire, X_test,y_test, gene_names,model_features, resolution=1.0, min_prop=0.0):
    ...
    file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/reports/classification_report_wistar_size_{X_train_size}.csv'
...
selected_ada = selected_ada[~selected_ada.obs['leiden1p2_labels'].isna()]
...
cell_type_counts = selected_ada.obs['leiden1p2_labels'].value_counts()
plt.figure(figsize=(10, 6))
cell_type_counts.plot(kind='bar', color='skyblue')
plt.title("Cell Type Distribution in wistar rat Data")
plt.xlabel("Cell Type")
plt.ylabel("Count")
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_wistar_entire.pdf", format="pdf")
...
for train_indices, test_indices in splitter.split(selected_ada.X, selected_ada.obs['leiden1p2_labels']):
    adata_train = selected_ada[train_indices].copy()
    adata_test = selected_ada[test_indices].copy()
X_train = adata_train.X
y_train = adata_train.obs["leiden1p2_labels"]
X_test = adata_test.X
y_test = adata_test.obs["leiden1p2_labels"]
...
#plt.xticks(rotation=45, ha="right")
#plt.tight_layout()
#plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_heca_train.pdf", format="pdf")
...
#plt.xticks(rotation=45, ha="right")
#plt.tight_layout()
#plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_heca_test.pdf", format="pdf")
...
for size in coreset_size:
    ...
    #plt.xticks(rotation=45, ha="right")
    #plt.tight_layout()
    #plt.savefig(f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/pdf/cell_type_distribution_heca_train_sampled_{size}.pdf", format="pdf")
