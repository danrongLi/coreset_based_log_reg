...
def run_pipeline(selected_ada, X_train,X_train_entire, y_train,y_train_entire, X_test,y_test, gene_names,model_features, resolution=1.0, min_prop=0.0):
    ...
    file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/reports/classification_report_heca_size_{X_train_size}_0.1.csv'
...
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_heca_entire_0.1.pdf", format="pdf")
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_heca_train_0.1.pdf", format="pdf")
...
plt.xticks(rotation=45, ha="right")
plt.tight_layout()
plt.savefig("/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_heca_test_0.1.pdf", format="pdf")
...
for size in coreset_size:
    ...
    plt.xticks(rotation=45, ha="right")
    plt.tight_layout()
    plt.savefig(f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/add_crossval_fix_cellnum/pdf/cell_type_distribution_heca_train_sampled_{size}_0.1.pdf", format="pdf")
