...
def scale_data_without_batch(X_data, scaler, lr_idx):
...
def run_pipeline(selected_ada, X_train,X_train_entire, y_train,y_train_entire, X_test,y_test, gene_names,model_features, resolution=1.0, min_prop=0.0):
    ...
    file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/reports/classification_report_skin_PCA_size_{X_train_size}.csv'
...
selected_ada = selected_ada[selected_ada.obs['celltype_coarse'].isin(valid_cell_types)].copy()
