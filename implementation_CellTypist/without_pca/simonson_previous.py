...
#file_name = f'/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/reports/classification_report_micedvc_celltypist_0001.csv'
file_name = f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/reports/classification_report_simonson_celltypist_{C}.csv"
...
#        f"test_train_split/pdf/confusion_matrix_micedvc_0001.pdf"
#    )

cm_file = (
    f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/"
    f"test_train_split/pdf/confusion_matrix_simonson_{C}.pdf"
)
plt.savefig(cm_file)
plt.close()
