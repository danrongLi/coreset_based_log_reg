...
file_name = f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/test_train_split/reports/classification_report_skin_celltypist_{C}.csv"
...
cm_file = (
    f"/storage/home/dvl5760/work/our_log_reg/change_coreset/add_loss/"
    f"test_train_split/pdf/confusion_matrix_skin_{C}.pdf"
)
plt.savefig(cm_file)
plt.close()
